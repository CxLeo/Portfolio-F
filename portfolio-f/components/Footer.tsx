...
function Footer() {
  ...
  return (
    <section className='w-screen bg-[#EEEEEE] h-fit'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <a href="mailto:franketns@gmail.com" className='flex hover:opacity-60'>
                            ...
                            <svg width="34" height="34" viewBox="0 0 27 26" fill="none" className='self-end ml-3'>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.225193 22.2599L17.3952 5.08981L2.00649 5.09574L2.00844 0.0262148L26.0514 0.0169506L26.0421 24.0599L20.9726 24.0619L20.9785 8.67314L3.80851 25.8432L0.225193 22.2599Z" fill="#00C7A8"/>
                            </svg>
                        </a>
                    </div>
